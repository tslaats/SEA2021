...
var dynamicTable = function () {
  ...
  function _setNoItemsInfo() {
    ...
    if (_table.children('tbody').length > 0) _table.children('tbody').html(content);else _table.append('<tbody>' + content + '</tbody>');
  }
  ...
  return {
    ...
    config: function config(tableId, fields, headers, defaultText) {
      _tableId = tableId;
      _table = $('#' + tableId);
      _fields = fields || null;
